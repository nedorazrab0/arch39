...
sed -i -e 's/font-size.*/font-size: 12px;/' -e 's/background-color.*/background-color: #000000;/' -e 's/border-bottom.*/border-bottom: 0px;/' \
       -e 's/button.focused/button.active/' -e 's/padding: 0 5px;/\/\/ padding: 0 5px;/' /etc/xdg/waybar/style.css
