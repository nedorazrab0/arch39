...
pacstrap -KP /mnt base linux-zen booster linux-firmware amd-ucode \
                  ...
                  hyprland polkit xdg-deskop-portal-hyprland mako kitty noto-fonts waybar otf-font-awesome brightnessctl grim slurp bluez{,-utils} pipewire{,-alsa,-pulse,-jack}
